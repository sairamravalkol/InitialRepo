...
public class ApplicationConstants {
	...
	public static final String WEB_SERVICE_HOST_NAME = "WEB_SERVICE_HOST";
	public static final String WEB_SERVICE_PORT = "PORT";
	...
	// MPI Properties
	public static final String TVG_TEST_MULTI_BIN_DIR_PATH = "TVG_TEST_MULTI_BIN_DIR_PATH";
	public static final String TVG_TEST_MULTI_CONF_DIR_PATH = "TVG_TEST_MULTI_CONF_DIR_PATH";
	public static final String NO_OF_MPI_PROCESS ="NO_OF_MPI_PROCESS";
