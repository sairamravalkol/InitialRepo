 ...
 *   Revised and extended by Vertica System, Inc., 2008
 *
 ...
 *
 * The convention is that new error codes defined by Vertica in a
 * class defined by the standard have a subclass value that begins
 * with 'V'.  Postgresql codes have been adopted by Vertica and changed
 * from class/subclass 'P' to 'V'.
 */
...
#define ERRCODE_WARNING_PRIVILEGE_ALREADY_GRANTED       MAKE_SQLSTATE('0','1', '0','0','8')
#define ERRCODE_WARNING_PRIVILEGE_ALREADY_REVOKED       MAKE_SQLSTATE('0','1', '0','0','9')
#define ERRCODE_WARNING_STRING_DATA_RIGHT_TRUNCATION    MAKE_SQLSTATE('0','1', '0','0','4')
#define ERRCODE_WARNING_DEPRECATED_FEATURE  MAKE_SQLSTATE('0','1', 'V','0','1')
#define ERRCODE_WARNING_QUERY_RETRIED       MAKE_SQLSTATE('0','1', 'V','0','2') 
...
#define ERRCODE_PROTOCOL_VIOLATION          MAKE_SQLSTATE('0','8', 'V','0','1')
...
#define ERRCODE_PLAN_TO_SQL_NOT_SUPPORTED   MAKE_SQLSTATE('0','A', '0','0','5')
...
#define ERRCODE_INVALID_GRANT_OPERATION     MAKE_SQLSTATE('0','L', 'V','0','1')
...
#define ERRCODE_ESCAPE_CHARACTER_ON_NOESCAPE MAKE_SQLSTATE('2','2', 'V','0','B')
...
#define ERRCODE_NONSTANDARD_USE_OF_ESCAPE_CHARACTER     MAKE_SQLSTATE('2','2', '9','0','6')
...
#define ERRCODE_FLOATING_POINT_EXCEPTION    MAKE_SQLSTATE('2','2', 'V','0','1')
#define ERRCODE_INVALID_TEXT_REPRESENTATION MAKE_SQLSTATE('2','2', 'V','0','2')
#define ERRCODE_INVALID_BINARY_REPRESENTATION   MAKE_SQLSTATE('2','2', 'V','0','3')
#define ERRCODE_BAD_COPY_FILE_FORMAT        MAKE_SQLSTATE('2','2', 'V','0','4')
#define ERRCODE_UNTRANSLATABLE_CHARACTER    MAKE_SQLSTATE('2','2', 'V','0','5')
/* Vertica extensions */
#define ERRCODE_INVALID_EPOCH               MAKE_SQLSTATE('2','2', 'V','2','1')
//!!DC temp until we figure out what we really want
#define ERRCODE_PLPGSQL_ERROR               MAKE_SQLSTATE('2','2', 'V','2','2')
//!!DC temp until we figure out what we really want
#define ERRCODE_RAISE_EXCEPTION             MAKE_SQLSTATE('2','2', 'V','2','3')
#define ERRCODE_COPY_PARSE_ERROR            MAKE_SQLSTATE('2','2', 'V','2','4')
...
#define ERRCODE_NO_ACTIVE_SQL_TRANSACTION   MAKE_SQLSTATE('2','5', 'V','0','1')
#define ERRCODE_IN_FAILED_SQL_TRANSACTION   MAKE_SQLSTATE('2','5', 'V','0','2')
...
#define ERRCODE_ACCOUNT_LOCKED                      MAKE_SQLSTATE('2','8', '0','0','1')
#define ERRCODE_PASSWORD_EXPIRED                    MAKE_SQLSTATE('2','8', '0','0','2')
#define ERRCODE_PASSWORD_IN_GRACE_PERIOD            MAKE_SQLSTATE('2','8', '0','0','3')

/* Class 2B - Dependent Privilege Descriptors Still Exist */
#define ERRCODE_DEPENDENT_PRIVILEGE_DESCRIPTORS_STILL_EXIST     MAKE_SQLSTATE('2','B', '0','0','0')
#define ERRCODE_DEPENDENT_OBJECTS_STILL_EXIST       MAKE_SQLSTATE('2','B', 'V','0','1')
...
#define ERRCODE_E_R_I_E_TRIGGER_PROTOCOL_VIOLATED   MAKE_SQLSTATE('3','9', 'V','0','1')
#define ERRCODE_E_R_I_E_SRF_PROTOCOL_VIOLATED   MAKE_SQLSTATE('3','9', 'V','0','2')
...
#define ERRCODE_T_R_DEADLOCK_DETECTED       MAKE_SQLSTATE('4','0', 'V','0','1')
...
#define ERRCODE_INDETERMINATE_DATATYPE      MAKE_SQLSTATE('4','2', 'V','1','8')
...
#define ERRCODE_UNDEFINED_TABLE             MAKE_SQLSTATE('4','2', 'V','0','1')
#define ERRCODE_UNDEFINED_PARAMETER         MAKE_SQLSTATE('4','2', 'V','0','2')
#define ERRCODE_UNDEFINED_OBJECT            MAKE_SQLSTATE('4','2', '7','0','4')
#define ERRCODE_DUPLICATE_COLUMN            MAKE_SQLSTATE('4','2', '7','0','1')
#define ERRCODE_DUPLICATE_CURSOR            MAKE_SQLSTATE('4','2', 'V','0','3')
#define ERRCODE_DUPLICATE_DATABASE          MAKE_SQLSTATE('4','2', 'V','0','4')
#define ERRCODE_DUPLICATE_FUNCTION          MAKE_SQLSTATE('4','2', '7','2','3')
#define ERRCODE_DUPLICATE_PSTATEMENT        MAKE_SQLSTATE('4','2', 'V','0','5')
#define ERRCODE_DUPLICATE_SCHEMA            MAKE_SQLSTATE('4','2', 'V','0','6')
#define ERRCODE_DUPLICATE_TABLE             MAKE_SQLSTATE('4','2', 'V','0','7')
...
#define ERRCODE_AMBIGUOUS_PARAMETER         MAKE_SQLSTATE('4','2', 'V','0','8')
#define ERRCODE_AMBIGUOUS_ALIAS             MAKE_SQLSTATE('4','2', 'V','0','9')
#define ERRCODE_INVALID_COLUMN_REFERENCE    MAKE_SQLSTATE('4','2', 'V','1','0')
#define ERRCODE_INVALID_COLUMN_DEFINITION   MAKE_SQLSTATE('4','2', '6','1','1')
#define ERRCODE_INVALID_CURSOR_DEFINITION   MAKE_SQLSTATE('4','2', 'V','1','1')
#define ERRCODE_INVALID_DATABASE_DEFINITION MAKE_SQLSTATE('4','2', 'V','1','2')
#define ERRCODE_INVALID_FUNCTION_DEFINITION MAKE_SQLSTATE('4','2', 'V','1','3')
#define ERRCODE_INVALID_PSTATEMENT_DEFINITION   MAKE_SQLSTATE('4','2', 'V','1','4')
#define ERRCODE_INVALID_SCHEMA_DEFINITION   MAKE_SQLSTATE('4','2', 'V','1','5')
#define ERRCODE_INVALID_TABLE_DEFINITION    MAKE_SQLSTATE('4','2', 'V','1','6')
#define ERRCODE_INVALID_OBJECT_DEFINITION   MAKE_SQLSTATE('4','2', 'V','1','7')
// Vertica extensions
#define ERRCODE_UNDEFINED_PROJECTION        MAKE_SQLSTATE('4','2', 'V','2','1')
#define ERRCODE_UNDEFINED_NODE              MAKE_SQLSTATE('4','2', 'V','2','2')
#define ERRCODE_UNDEFINED_PERMUTATION       MAKE_SQLSTATE('4','2', 'V','2','3')
#define ERRCODE_UNDEFINED_USER              MAKE_SQLSTATE('4','2', 'V','2','4')
#define ERRCODE_PATTERN_MATCH_ERROR         MAKE_SQLSTATE('4','2', 'V','2','5')
#define ERRCODE_DUPLICATE_NODE              MAKE_SQLSTATE('4','2', 'V','2','6')
...
#define ERRCODE_CANT_CHANGE_RUNTIME_PARAM   MAKE_SQLSTATE('5','5', 'V','0','2')
#define ERRCODE_LOCK_NOT_AVAILABLE          MAKE_SQLSTATE('5','5', 'V','0','3')
#define ERRCODE_TM_MARKER_NOT_AVAILABLE     MAKE_SQLSTATE('5','5', 'V','0','4')

/* Class 57 - Operator Intervention (class borrowed from DB2) */
#define ERRCODE_OPERATOR_INTERVENTION       MAKE_SQLSTATE('5','7', '0','0','0')
#define ERRCODE_QUERY_CANCELED              MAKE_SQLSTATE('5','7', '0','1','4')
#define ERRCODE_ADMIN_SHUTDOWN              MAKE_SQLSTATE('5','7', 'V','0','1')
#define ERRCODE_CRASH_SHUTDOWN              MAKE_SQLSTATE('5','7', 'V','0','2')
#define ERRCODE_CANNOT_CONNECT_NOW          MAKE_SQLSTATE('5','7', 'V','0','3')
#define ERRCODE_SLOW_DELETE                 MAKE_SQLSTATE('5','7', '0','1','5')
...
#define ERRCODE_UNDEFINED_FILE              MAKE_SQLSTATE('5','8', 'V','0','1')
#define ERRCODE_DUPLICATE_FILE              MAKE_SQLSTATE('5','8', 'V','0','2')

/* Class VC - Configuration File Error (Vertica-specific error class) */
#define ERRCODE_CONFIG_FILE_ERROR           MAKE_SQLSTATE('V','C', '0','0','1')
#define ERRCODE_LOCK_FILE_EXISTS            MAKE_SQLSTATE('V','C', '0','0','2')

/* Class VD - DB Designer errors (Vertica-specific error class) */
#define ERRCODE_DESIGNER_FUNCTION_ERROR     MAKE_SQLSTATE('V','D', '0','0','1')

/* Class VP - User procedure errors (Vertica-specific error class) */
#define ERRCODE_USER_PROC_ERROR             MAKE_SQLSTATE('V','P', '0','0','0')
#define ERRCODE_USER_PROC_EXEC_ERROR        MAKE_SQLSTATE('V','P', '0','0','1')

/* Class V1 - Vertica-specific multi-node errors class */
#define ERRCODE_LOST_CONNECTIVITY           MAKE_SQLSTATE('V','1', '0','0','1')
#define ERRCODE_K_SAFETY_VIOLATION          MAKE_SQLSTATE('V','1', '0','0','2')
#define ERRCODE_CLUSTER_CHANGE              MAKE_SQLSTATE('V','1', '0','0','3')

/* Class V2 - Vertica-specific miscellaneous errors class */
#define ERRCODE_LICENSE_ISSUE               MAKE_SQLSTATE('V','2', '0','0','1')
#define ERRCODE_MOVEOUT_ABORTED             MAKE_SQLSTATE('V','2', '0','0','2')
#define ERRCODE_AUTH_FAILED                 MAKE_SQLSTATE('V','2', '0','0','0')

/* Class VX - Internal Error (Vertica-specific error class) */
/* (this is for "can't-happen" conditions and software bugs) */
#define ERRCODE_INTERNAL_ERROR              MAKE_SQLSTATE('V','X', '0','0','1')
#define ERRCODE_DATA_CORRUPTED              MAKE_SQLSTATE('V','X', '0','0','2')
#define ERRCODE_INDEX_CORRUPTED             MAKE_SQLSTATE('V','X', '0','0','3')
#define ERRCODE_PLAN_TO_SQL_INTERNAL_EROR   MAKE_SQLSTATE('V','X', '0','0','4')
